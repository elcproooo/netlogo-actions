...
This document is used to test the [netlogo-actions](https://github.com/danielvartan/netlogo-check) [GitHub Actions](https://github.com/features/actions/) under the different experiments set in the *Wolf Sheep Predation* model, included in NetLogo along with the *Sample Models* library.
